...
## Project Structure
    ...
    ├── ideapros_llc_vista_32437  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_vista_32437`
...
2. Clone this repo and `cd ideapros_llc_vista_32437`
